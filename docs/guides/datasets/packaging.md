...
- **SELF-DEPENDENCY & COMPLETENESS**: the data resource ought to be be easily interpreted and used by itself.
...
We suggest grouping hazard data using the following hierarchy:
...
We suggest grouping exposure data using the following hierarchy:
...
In either case, we suggest grouping exposure data using the following hierarchy:
