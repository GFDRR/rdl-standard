...
1. **Exposure dataset**: Infrastructure inventory (with version)
1. **Vulnerability dataset**: Damage functions applied (with source)
1. **Validation**: Historical losses used for calibration (if available)
