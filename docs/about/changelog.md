...
- [#223](https://github.com/GFDRR/rdl-standard/pull/223) - Remove section on disaster ID (which included only GLIDE) - replacing with scheme codelist and descriptions. 
